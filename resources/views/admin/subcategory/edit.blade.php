      ...
      <div class="row">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action={{route('sub_category.edit', ['id' => $record->id])}} method="post">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Name<span style="color: red">*</span></label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Category Name"  name="name" value='{{$record->name}}'>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea  class="form-control" id="exampleInputEmail1" placeholder="Meta Description"  name="meta_description" >{{$record->meta_description}}</textarea>
