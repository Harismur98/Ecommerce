      ...
      <div class="row">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action={{route('colour.edit', ['id' => $record->id])}} method="post">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="color" class="form-control" id="exampleInputEmail1" placeholder="slug"  name="slug" value={{$record->code}}>
